raspbian-pi-netinst build instructions
======================================
...
```
apt-get install git wget bzip2 zip xz-utils gnupg kpartx dosfstools binutils bc
```

The following scripts are used to build the raspbian-pi-netinst installer, listed in the same order they would be used:
